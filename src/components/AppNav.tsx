...
const NAV_BY_ROL: Record<Rol, NavItem[]> = {
  trabajador_nuevo: [{ href: "/chat", label: "Asistente", icon: "💬" }, { href: "/mis-turnos", label: "Mis primeras ventas", icon: "🎯" }],
  experto: [{ href: "/experto/unidades", label: "Mi conocimiento", icon: "📚" }, { href: "/experto/contrastes", label: "Contrastar", icon: "🔎" }, { href: "/experto/aportar", label: "Aportar", icon: "✍️" }],
  validador: [{ href: "/validador/bandeja", label: "Bandeja", icon: "✅" }],
  admin: [{ href: "/admin/dashboard", label: "Dashboard", icon: "📊" }, { href: "/admin/cargos", label: "Cargos", icon: "🏷️" }, { href: "/admin/usuarios", label: "Usuarios", icon: "👥" }, { href: "/admin/qr", label: "QR", icon: "🔲" }],
};
